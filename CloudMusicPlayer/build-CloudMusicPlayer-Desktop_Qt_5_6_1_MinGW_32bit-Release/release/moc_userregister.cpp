...
#include "../../CloudMusicPlayer/userregister.h"
...
QT_MOC_LITERAL(1, 13, 17), // "backToLoginWidget"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 17) // "doProcessRegister"

    },
    "userRegister\0backToLoginWidget\0\0"
    "doProcessRegister"
};
...
void userRegister::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        userRegister *_t = static_cast<userRegister *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->backToLoginWidget(); break;
        case 1: _t->doProcessRegister(); break;
        default: ;
        }
        ...
        {
            typedef void (userRegister::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&userRegister::backToLoginWidget)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject userRegister::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_userRegister.data,
      qt_meta_data_userRegister,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void userRegister::backToLoginWidget()
{
