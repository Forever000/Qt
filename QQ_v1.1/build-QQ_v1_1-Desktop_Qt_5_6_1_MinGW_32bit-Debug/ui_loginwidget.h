...
public:
    ...
    {
        loginWidget->setWindowTitle(QApplication::translate("loginWidget", "QQ_v1.1", 0));
        btn_Login_in->setText(QApplication::translate("loginWidget", "\347\231\273\345\275\225", 0));
        btn_Register->setText(QApplication::translate("loginWidget", "\346\263\250\345\206\214", 0));
        label->setText(QApplication::translate("loginWidget", "\350\264\246\345\217\267\357\274\232", 0));
