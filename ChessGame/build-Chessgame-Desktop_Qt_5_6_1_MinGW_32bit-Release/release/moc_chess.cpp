...
QT_MOC_LITERAL(1, 6, 19), // "SignalSendChessDate"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 1), // "i"
QT_MOC_LITERAL(4, 29, 1) // "j"

    },
    "Chess\0SignalSendChessDate\0\0i\0j"
};
...
void Chess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SignalSendChessDate((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (Chess::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Chess::SignalSendChessDate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Chess::SignalSendChessDate(int _t1, int _t2)
{
